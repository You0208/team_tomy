...
namespace Lemur::Graphics
{
	...
	Graphics::Graphics(HWND hwnd, bool fullscreen) : hwnd(hwnd), fullscreen_mode(fullscreen), windowed_style(static_cast<DWORD>(GetWindowLongPtrW(hwnd, GWL_STYLE)))
	{
		...
		hr = g_pDWriteFactory->CreateTextFormat(L"Century", nullptr, DWRITE_FONT_WEIGHT_NORMAL, DWRITE_FONT_STYLE_NORMAL, DWRITE_FONT_STRETCH_NORMAL, 20, L"", &g_pTextFormat);
		hr = g_pDWriteFactory->CreateTextFormat(L"Century", nullptr, DWRITE_FONT_WEIGHT_NORMAL, DWRITE_FONT_STYLE_NORMAL, DWRITE_FONT_STRETCH_NORMAL, 5, L"", &TextFormat_1);
		...
		hr = TextFormat_1->SetTextAlignment(DWRITE_TEXT_ALIGNMENT_LEADING);

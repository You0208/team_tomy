...
public:
	struct vertex
	{
		...
		DirectX::XMFLOAT2 texcoord;// 頂点データをピクセルシェーダに
	};
	struct constants
	{
...
public:
	...
	void render(ID3D11DeviceContext* immediate_context, const DirectX::XMFLOAT4X4& world, const DirectX::XMFLOAT4& material_color, ID3D11PixelShader* alternative_pixel_shader = nullptr);

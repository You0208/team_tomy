...
void GambleScene::Initialize()
{
	...
	spr_number_sel = std::make_unique<sprite>(graphics.GetDevice(), L"./resources/Image/数字＿背景.png");
	...
	spr_skill[15] = std::make_unique<sprite>(graphics.GetDevice(), L"./resources/Image/skill/超人.png");//TODO
